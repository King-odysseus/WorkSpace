...
# Transactional email (invitations, task/calendar reminders) via Brevo's HTTPS
# REST API (tasks.mailer.BrevoAPIEmailBackend), same approach as TijhaBooks'
...
EMAIL_SENDING_CONFIGURED = bool(BREVO_API_KEY)
