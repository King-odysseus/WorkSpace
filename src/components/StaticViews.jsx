...
function LegalView() {
  ...
  const documents = {
    privacy: { label: 'Privacy & GDPR', title: 'Privacy notice', intro: 'This notice explains what personal data WorkSpace uses, why it is used, and the choices available to you.', sections: [['What we collect', 'Account details, workspace membership, tasks, messages, calendar entries, check-ins, and technical information needed to keep the service secure.'], ['Why we use it', 'We use this data to provide the workspace, authenticate users, deliver notifications, support collaboration, prevent abuse, and improve reliability.'], ['Your rights', 'Depending on your location, you may have rights to access, correct, export, restrict, object to, or delete your personal data. Contact your workspace administrator to make a request.'], ['Screen sharing and screenshots', 'If your workspace owner enables screen sharing, a manager may send you a request. Sharing never starts on its own: you must accept and pick a screen, window, or tab in your browser, and you can stop at any time. While a session is active WorkSpace saves still screenshots at the interval shown to you. No audio, webcam, keystroke, or remote-control data is collected. Only workspace owners and managers can view or download screenshots, you can review your own, every access is audited, and screenshots are deleted automatically after the retention period your workspace has configured.'], ['Retention and security', 'We retain workspace data for as long as the workspace is active or as required for legitimate business and legal purposes. Screen-sharing screenshots are deleted automatically after their configured retention period. Access controls, authentication, and audit records help protect it.']] },
